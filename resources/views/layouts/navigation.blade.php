<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('teacher.transfers')" :active="request()->routeIs('teacher.transfers*')">
                {{ __('Transfers') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('teacher.students')" :active="request()->routeIs('teacher.students')">
                {{ __('My Students') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('teacher.profile')" :active="request()->routeIs('teacher.profile')">
                {{ __('My Profile') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('teacher.availability')" :active="request()->routeIs('teacher.availability')">
                {{ __('My Availability') }}
            </x-responsive-nav-link>
            @endrole
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-gray-500">{{ Auth::check() ? Auth::user()->email : 'Please log in' }}</div>
            </div>
