                            ...
                            <div>
                                ...
                                <div class="mb-6">
                                    ...
                                    >
                                        ...
                                        <option value="children" {{ old('teaching_type', $profile->teaching_type ?? '') == 'children' ? 'selected' : '' }}>Children</option>
                                        ...
                                        <option value="all" {{ old('teaching_type', $profile->teaching_type ?? '') == 'all' ? 'selected' : '' }}>All</option>
                                    </select>
                                    @error('teaching_type')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
